...
type UserClient interface {
	...
	Register(ctx context.Context, in *UserRegisterLoginRequest, opts ...grpc.CallOption) (*UserRegisterLoginResponse, error)
	Login(ctx context.Context, in *UserRegisterLoginRequest, opts ...grpc.CallOption) (*UserRegisterLoginResponse, error)
}
...
func (c *userClient) Register(ctx context.Context, in *UserRegisterLoginRequest, opts ...grpc.CallOption) (*UserRegisterLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserRegisterLoginResponse)
...
func (c *userClient) Login(ctx context.Context, in *UserRegisterLoginRequest, opts ...grpc.CallOption) (*UserRegisterLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserRegisterLoginResponse)
...
func (UnimplementedUserServer) Register(context.Context, *UserRegisterLoginRequest) (*UserRegisterLoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserServer) Login(context.Context, *UserRegisterLoginRequest) (*UserRegisterLoginResponse, error) {
...
func _User_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRegisterLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Register(ctx, req.(*UserRegisterLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Login(ctx, req.(*UserRegisterLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
